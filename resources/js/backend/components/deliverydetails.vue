                        ...
                        <v-container>
                            <v-row>
                                <v-col cols="12" sm="12" md="12">
                                    <v-text-field name="deliveryAddressTitle" label="Delivery Address Title*" v-model="deliveryaddresscrud.deliveryAddressTitle"
                                        :rules="deliveryAddressTitleRules"
                                        :error-messages="deliveryaddresscrudError.deliveryAddressTitle"
                                        clearable
                                ...
                                <v-col cols="12" sm="12" md="12">
                                    ...
                                    v-model="deliveryaddresscrud.deliveryAddress"
                                    auto-grow  outlined  rows="3"
                                    :rules="deliveryAddressRules"
                                    :error-messages="deliveryaddresscrudError.deliveryAddress"
                                    counter
                                    clearable
                                ...
                                <v-col cols="12" sm="12" md="12">
                                    <v-autocomplete
                                        ...
                                        id="areaId"
                                        name="areaId"
                                        v-model="deliveryaddresscrud.areaId"
                                        clearable
                                        chips
                                        :rules="areaIdRules"
                                        :error-messages="deliveryaddresscrudError.areaId"
                                    ></v-autocomplete>
                                </v-col>
...
export default {
    ...
    mounted() {
        this.getAUserDeliveryAddresses(this.userId)
        this.getAreas();
        this.loading=false;
    ...
    methods: {
        getAUserDeliveryAddresses(){
            this.deliveryaddress={}
            var _this = this;
            axios.get('/api/getAUserDeliveryAddresses/'+this.userId+'?token='+this.token)
        ...
        clearForm(){
            this.deliveryaddresscrud= {
                deliveryAddressTitle: '',
                deliveryAddress: '',
                areaId: '',
            }
            this.deliveryaddresscrudError= {
                deliveryAddressTitle: '',
                deliveryAddress: '',
                areaId: '',
            }
            ...
            this.$emit('setDeliveryAddress', this.deliveryaddress)
        ...
        adding(){
            ...
            var _this=this
            axios.post('/api/addAUserDeliveryAddress/'+this.userId+'?token='+this.token,  this.deliveryaddresscrud )
            .then(function (response) {
                _this.getAUserDeliveryAddresses(_this.userId)
                _this.s_alert = true;
            ...
            .catch(function (error) {
                _this.e_alert = true;
                _this.deliveryaddresscrudError = {
        ...
        setEditDialogFields(id){
            ...
            .then(function (response) {
                _this.deliveryaddresscrud = response.data.data;
            })
            .catch(function (error) {
            })
        },
        ...
        editing(){
            var _this = this;
            axios.post('/api/editDeliveryAddress?token='+this.token, this.deliveryaddresscrud)
            .then(function (response) {
                _this.s_alert = true;
    ...
    watch: {
        ...
        userId: function (newValue, oldValue) {
            ...
            if (newValue!=oldValue && newValue) {
                this.getAUserDeliveryAddresses()
            }
            else{
